...
public class Listener implements ActionListener, MouseListener, MouseMotionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("")){
            ...
            final JFrame frame = new JFrame("Color Panel");
            frame.setSize(300, 300);
            frame.setLocationRelativeTo(null);
            frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
            Color curColor = JColorChooser.showDialog(frame, "Choose color", null);
            if (curColor != null) {
                color = curColor;
            }
        } else {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (type.equals("Free")) {
            ...
            message =  formRecord("Line", rgb, startX, startY, startX, startY);
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (type.equals("Line")) {
            ...
            messageList.add(message);
            try {
                Connection.broadcast("draw " + message);
